 ...
 *               weight:
 *                 type: number
 *                 description: Вес оборудования (kg), участвует в rack alerts
 *                 example: 18
 *               energy_consumption:
 *                 type: number
 *                 description: Энергопотребление оборудования (W), участвует в rack alerts
 *                 example: 650
 *               rack_unit_size:
 *                 type: integer
 *                 description: Высота устройства в U (опционально, также можно передать unit_size)
 *                 example: 2
 *               serverData:
 *                 type: object
 ...
 *               weight:
 *                 type: number
 *                 description: Новый вес оборудования (kg)
 *                 example: 20
 *               energy_consumption:
 *                 type: number
 *                 description: Новое энергопотребление оборудования (W)
 *                 example: 720
 *           examples:
 ...
 *               model:
 *                 type: string
 *                 description: Модель ИБП (опционально, по умолчанию UPS)
 *                 example: APC Smart-UPS 3000
 *               serial:
 *                 type: string
 *                 description: Серийный номер ИБП (опционально)
 *                 example: UPS-3000-001
 *               status:
 *                 type: string
 *                 example: available
 *               weight:
 *                 type: number
 *                 description: Вес ИБП (kg), участвует в rack alerts
 *                 example: 35
 *               energy_consumption:
 *                 type: number
 *                 description: Энергопотребление ИБП (W), участвует в rack alerts
 *                 example: 500
 *               rack_unit_size:
 *                 type: integer
 *                 description: Высота ИБП в U (опционально, также можно передать unit_size)
 *                 example: 2
 *               upsData:
 *                 type: object
 ...
 *     description: Возвращает список портов для ИБП по asset ID
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - name: id
